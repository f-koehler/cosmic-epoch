...
```
sudo apt install just rustc cargo meson libdbus-1-dev libgbm-dev libglvnd-dev libwayland-dev libseat-dev libxkbcommon-dev libinput-dev libgtk-4-1 udev dbus -y
```
